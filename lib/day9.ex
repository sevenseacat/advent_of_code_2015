defmodule Day9 do
  @doc """
  iex> Day9.part1("London to Dublin = 464\\nLondon to Belfast = 518\\nDublin to Belfast = 141")
  ...
  @doc """
  iex> Day9.part2("London to Dublin = 464\\nLondon to Belfast = 518\\nDublin to Belfast = 141")
  ...
  @doc """
  iex> Day9.parse_input("London to Dublin = 464\\nLondon to Belfast = 518\\nDublin to Belfast = 141")
  ...
  def bench do
    Benchee.run(
      %{
        "day 9, part 1" => fn -> Advent.data(9) |> Day9.part1() end,
        "day 9, part 2" => fn -> Advent.data(9) |> Day9.part2() end
      },
